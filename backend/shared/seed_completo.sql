...
INSERT INTO CandidatoSeguridad (id, nombre_cifrado, email_cifrado, estado_gdpr) VALUES
  ...
  (5, UNHEX('0233e2cc670d1be90c5dafc3cf6a6045'), UNHEX('b6d1aa732d9d0a24ebbd376d98a33b62835a2ea5c1d43e839cb5ae029a9dff7b'), 'activo'),
  (6, UNHEX('893fd5cc701eea36783ac6eac7e3cee3'), UNHEX('a7562f4e95c88824119c338b16f8e4efb422ca88e77e062d4654723ea0530d8a'), 'activo')
ON DUPLICATE KEY UPDATE
  nombre_cifrado = VALUES(nombre_cifrado),
  email_cifrado = VALUES(email_cifrado),
  estado_gdpr = VALUES(estado_gdpr);

ALTER TABLE CandidatoSeguridad AUTO_INCREMENT = 7;
